      ...
      <script>
        ...
        const strings = {
          en: {
            ...
            "block-porn-remarks": "If you check this option, porn websites will be blocked and all protocols will be deactivated except built-in AMK protocol.",
          ...
          fa: {
            ...
            "block-porn-remarks": "در صورت فعال‌سازی این گزینه، همزمان با مسدودسازی پورن تمام پروتکل‌ها بجز AMK های داخلی ورکر نیز غیرفعال می‌شوند.",
        ...
        <form class="px-4 py-4 border-top border-2 border-primary" method="post">
          ...
          <div class="mb-1 p-1">
            ...
            <div id="type">
              ...
              <div>
                <input type="checkbox" name="protocols" value="AMK" class="form-check-input" id="AMK-protocol-ckeck" ${protocols.includes('AMK') ? "checked" : ""} />
                <label class="form-check-label" for="AMK-protocol-ckeck">AMK</label>
              </div>
              <div>
                <input type="checkbox" name="protocols" value="built-in-AMK" class="form-check-input" id="built-in-AMK-protocol-ckeck" ${protocols.includes('built-in-AMK') ? "checked" : ""} />
                <label class="form-check-label" for="built-in-AMK-protocol-ckeck">Built-in AMK</label>
              </div>
              <div>
                <input type="checkbox" name="protocols" value="built-in-ELE" class="form-check-input" id="built-in-ELE-protocol-ckeck" ${protocols.includes('built-in-ELE') ? "checked" : ""} />
                <label class="form-check-label" for="built-in-ELE-protocol-ckeck">Built-in Trojan</label>
              </div>
            </div>
          </div>
